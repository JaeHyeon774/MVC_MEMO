...
<body>
	...
	<div class="container">
		...
		<div class="page-header row">
			<div class="col-sm-4">
				<img src="<%=root %>/template/images/img_chania.jpg"
		...
		<ul class="nav nav-tabs">
			...
			<li class="dropdown"><a class="dropdown-toggle"
				data-toggle="dropdown" href="#">메모장 <span class="caret"></span></a>
				<ul class="dropdown-menu">
					<li><a href="<%=root %>/memo/list.do">게시판 목록</a></li>
					<li><a href="<%=root %>/memo/create.do">게시판 생성</a></li>
				</ul></li>
		</ul>
	</div>
</body>
